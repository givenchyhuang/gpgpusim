...
/* Line 268 of yacc.c  */
#line 79 "/home/paslab02/gpgpu-sim_distribution/build/gcc-4.4.7/cuda-4000/release/cuda-sim/ptxinfo.tab.c"
...
/* Line 293 of yacc.c  */
#line 145 "/home/paslab02/gpgpu-sim_distribution/build/gcc-4.4.7/cuda-4000/release/cuda-sim/ptxinfo.tab.c"
} YYSTYPE;
...
/* Line 343 of yacc.c  */
#line 174 "/home/paslab02/gpgpu-sim_distribution/build/gcc-4.4.7/cuda-4000/release/cuda-sim/ptxinfo.tab.c"
...
{
       0,     0,     3,     4,     7,    12,    20,    23,    25,    27,
      32,    41,    43,    47,    51,    54,    57,    64,    68,    72,
      76,    79
};
...
{
      25,     0,    -1,    -1,    25,    26,    -1,     4,     5,    18,
      27,    -1,     4,    13,    15,    21,     3,    19,    22,    -1,
       4,    22,    -1,    28,    -1,    29,    -1,     6,    20,    13,
      20,    -1,     6,    20,    13,    20,    23,    20,    13,    20,
      -1,    30,    -1,    29,    15,    30,    -1,     7,     3,     8,
      -1,    31,    10,    -1,    31,    11,    -1,     3,     9,    12,
      16,     3,    17,    -1,     3,     9,    10,    -1,     3,     9,
      11,    -1,     3,     9,    12,    -1,     3,     8,    -1,     3,
      14,     3,     9,    -1
};
...
static const char *const yytname[] =
{
  ...
  "line", "line_info", "function_name", "function_info", "info", "tuple", 0
};
#endif
...
/* Line 1806 of yacc.c  */
#line 88 "ptxinfo.y"
    { ptxinfo_function((yyvsp[(3) - (4)].string_value)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 89 "ptxinfo.y"
    { ptxinfo_function((yyvsp[(3) - (8)].string_value)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 95 "ptxinfo.y"
    { ptxinfo_regs((yyvsp[(2) - (3)].int_value)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 98 "ptxinfo.y"
    { ptxinfo_cmem((yyvsp[(1) - (6)].int_value),(yyvsp[(5) - (6)].int_value)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 99 "ptxinfo.y"
    { ptxinfo_lmem((yyvsp[(1) - (3)].int_value),0); }
    break;
...
/* Line 1806 of yacc.c  */
#line 100 "ptxinfo.y"
    { ptxinfo_smem((yyvsp[(1) - (3)].int_value),0); }
    break;
...
/* Line 1806 of yacc.c  */
#line 101 "ptxinfo.y"
    { ptxinfo_cmem((yyvsp[(1) - (3)].int_value),0); }
    break;
...
/* Line 1806 of yacc.c  */
#line 102 "ptxinfo.y"
    { ptxinfo_regs((yyvsp[(1) - (2)].int_value)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 105 "ptxinfo.y"
    { g_declared=(yyvsp[(1) - (4)].int_value); g_system=(yyvsp[(3) - (4)].int_value); }
    break;



/* Line 1806 of yacc.c  */
#line 1517 "/home/paslab02/gpgpu-sim_distribution/build/gcc-4.4.7/cuda-4000/release/cuda-sim/ptxinfo.tab.c"
      default: break;
    }
